...
const char *WINDOWTITLE = { "Bezier Curve" };
...
float blend0(float t) {
	return (1 - t) * (1 - t) * (1 - t);
}

float blend1(float t) {
	return 3.0 * (1 - t) * (1 - t) * t;
}

float blend2(float t) {
	return 3.0 * (1 - t) * t * t;
}

float blend3(float t) {
	return t * t * t;
}
...
Display( )
{
	...
	GLfloat ctrlpoints[4][3] = {
		{ 0.0, 8.0, -1.0 },{ 3.0, 8.0, 0.0 },
		{ 2.0, 3.0, 0.0 },{ 4.0, 1.0, -1.0 } };
	GLfloat ctrlpoints2[4][3] = {
		{ 0.0, 8.0, -1.0 }, { -3.0, 8.0, 0.0 },
		{ -2.0, 3.0, 0.0 }, { -4.0, 1.0, -1.0 } };
	GLfloat ctrlpoints3[4][3] = {
		{ -4.0, 1.0, -1.0 },{ -2.0, -1.0, 0.0 },
		{ 2.0, -1.0, 0.0 },{ 4.0, 1.0, -1.0 } };
	
	GLfloat ctrlpoints4[4][3] = {
		{ -0.50, -2.0, 0.0 },{ -0.25, -2.5, 0.0 },
		{ 0.25, -2.5, 0.0 },{ 0.50, -2.0, 0.0 } };
	GLfloat ctrlpoints5[4][3] = {
		{ -0.50, -2.0, 0.0 },{ -0.25, -1.5, 0.0 },
		{ 0.25, -1.5, 0.0 },{ 0.50, -2.0, 0.0 } };


	GLfloat ctrlpoints6[4][3] = {
		{ 0.0, -1.5, 0.0 },{ 0.0, -0.75, 0.0 },
		{ 0.0, -0.70, 0.0 },{ 0.0, -0.5, 0.0 } };
	...
	if (pointOn)
	{
		...
		for (i = 0; i < 4; i++)
		{
			...
			glVertex3fv(&ctrlpoints4[i][0]);
			glVertex3fv(&ctrlpoints5[i][0]);
